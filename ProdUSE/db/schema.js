...
async function openDatabase(){
    ...
    //create database
    const db = await SQLite.openDatabaseAsync('produseDB.db', {enableChangeListener : true});
    ...
    db.withTransactionSync(() => {
        db.runSync(`
            ...
            CREATE TABLE IF NOT EXISTS perishableItems (
                ...
                imageURL TEXT DEFAULT 'https://picsum.photos/seed/696/3000/2000',
                );
...
// initial_quantity REAL,  <-- removed attribute from perishableitems
